...
This skill is loaded during `/conductor:bd-plan` → "Enhance Prompts" activity.
...
| Resource | Purpose |
|----------|---------|
| [../../references/worker-prompt-guidelines.md](../../references/worker-prompt-guidelines.md) | Prompt quality principles |
| [../../references/anthropic-prompting-guide.md](../../references/anthropic-prompting-guide.md) | Full Claude 4.x prompting guide |
...
| `/conductor:bd-plan` | Parent workflow that uses this skill |
